...
const UploadImages = ({ onChange,images,buttonImageUnload }) => {
  const maxNumber = 12;
      ...
      >
        {({
          ...
          <div className="upload__image-wrapper">
            <button
              ref={buttonImageUnload}
              className="hidden"
              /// <reference path="" />
              style={isDragging ? { color: "red", display: "none" } : undefined}
            ...
            <div className="grid grid-cols-2 gap-3">
              {imageList.map((image, index) => (
                ...
                >
                  ...
                  />
                  <div className="image-item__btn-wrapper absolute top-1 left-1">
