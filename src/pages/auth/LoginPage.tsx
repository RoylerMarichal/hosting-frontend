...
import { GET_CURRENT_USER, LOGIN_USER } from "../../utils/queries";
...
const LoginPage = () => {
  const [typeSelected, setTypeSelected] = useState("PERSON");
  ...
  //auth/login/login Function con Apollo Client
  return (
    <>
      {action === "login" ? (
        <>
                ...
                <form onSubmit={onSubmitRegister} className="space-y-6">
                  ...
                  <div>
                    <button
                      ...
                      className="flex w-full justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                    >
                      {loadingRegister && <Loading />} Regístrate
                    </button>
                  </div>
                </form>
